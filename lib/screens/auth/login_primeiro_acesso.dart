                      ...
                      Botaoprincipal(
                        ...
                        onPressed: () async {
                          try {
                            ...
                            GerenciaPacienteRepository gerencia =
                                GerenciaPacienteRepository();

                            final paciente = await gerencia.verificaSenha(
                                senhaAcessoController.text,
                                emailController.text,
                                cnsController.text);

                            final pacient =
                                paciente!['paciente'] as PacienteModel;
                            final uid = paciente['uidColletion'];

                            final user = await AuthRepository().criarUsuario(
                                emailController.text, senhaController.text);

                            pacient.dadosPacienteModel.statusConta =
                                EnumStatusConta.ativo.name;
                            pacient.dadosPacienteModel.uidPaciente =
                                user.user!.uid;

                            await gerencia.editarPaciente(
                                pacient.dadosPacienteModel, uid.toString());
